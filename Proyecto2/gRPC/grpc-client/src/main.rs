...
const SERVERS: [&str; 3] = [
    "http://go-server-natacion-service:50051", // Para disciplina 1
    "http://go-server-atletismo-service:50052", // Para disciplina 2
    "http://go-server-boxeo-service:50053", // Para disciplina 3
];
